...
export default function Sidebar(){
    return(
        <>
            <aside id="separator-sidebar" className=" top-0 left-0 z-40 w-64 h-screen relative transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto ">
                    <ul className="space-y-2 font-medium">
                        <li>
                            ...
                            <Link href={'/'} className="flex-1 ml-3 whitespace-nowrap">Dashboard</Link>
                        ...
                        <li>
                            ...
                            <span className="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-white bg-blue-900 rounded-full">3</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 group">
                            ...
                            <Link href={'/user/account/profile/'} className="flex-1 ml-3 whitespace-nowrap">Profile</Link>
                            </a>
                        </li>
                        <li>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                            ...
                            <Link href={'/order'} className="flex-1 ml-3 whitespace-nowrap">Products</Link>
                            </a>
                        </li>
                    ...
                    <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                        <li>
                            ...
                            <Link href={'/seller_onboarding'} className="ml-4">Became a seller</Link>
                            </a>
                        </li>
                        <li>
                            <a href="#" className="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group">
