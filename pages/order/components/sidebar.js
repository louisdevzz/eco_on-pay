...
export default function Sidebar(){
    return(
        <>
            <aside id="separator-sidebar" class=" top-0 left-0 z-40 w-64 h-screen relative transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div class="h-full px-3 py-4 overflow-y-auto ">
                    <ul class="space-y-2 font-medium">
                        <li>
                            ...
                            <Link href={'/'} class="flex-1 ml-3 whitespace-nowrap">Dashboard</Link>
                        ...
                        <li>
                            ...
                            <Link href={'/user/account/profile/'} class="flex-1 ml-3 whitespace-nowrap">Profile</Link>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <Link href={'/order'} class="flex-1 ml-3 whitespace-nowrap">Products</Link>
                            </a>
                        </li>
                    ...
                    <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                        <li>
                            ...
                            <Link href={'/seller_onboarding'} class="ml-4">Became a seller</Link>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
